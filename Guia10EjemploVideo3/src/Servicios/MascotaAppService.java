...
//    }
    ...
    public void actualizarMascota(int index) {
        ...
        if (index <= (mascotas.size() - 1)) {
            ...
            MascotaApp m = crearMascota();
            mascotas.set(index, m);
        } else {
            System.out.println("Fallo al actualizar, el indice es erroreo");
        }

    }

    public void eliminarMascota(int index) {//recibimos indice
        
        if (index <= (mascotas.size() - 1)) {
                mascotas.remove(index);
        } else {
            System.out.println("Fallo al eliminar, el indice es erroreo");
        }
    }
}
